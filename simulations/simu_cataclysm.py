...
#Simulation: Cataclystic event

#Classes------------------------------------------------
Au = 150e9 #Distance to the Sun from Earth.
numcom = 0 # Number of comets to be generated
class objectlist:
    name          = ""
    mass          = 0 #kg
...
BH.name = "Black Hole"
BH.mass = 8*Sun.mass
BH.distance = [50*Au,50*Au]
BH.velocity = [-50000,-100000]
...
print("Simulation: Cataclystic event with rogue black hole")
l_obj = [Sun,Mercury,Venus,Earth,Mars,Jupiter,Saturn,Uranus,Neptune, BH]
