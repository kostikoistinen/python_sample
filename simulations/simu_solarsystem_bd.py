...
BD.distance = [-5*Au, -10*Au]
BD.velocity = [20000,28000]
BD.track = copy.deepcopy(BD.distance)
BD.color = "brown"
BD.size = 25
BD.radius = 700000e3

print("Simulation: Brown dwarf passing solar system inner parts")

l_obj = [Sun,Mercury,Venus,Earth,Mars,Jupiter,Saturn,Uranus,Neptune,BD]
table = PrettyTable()
